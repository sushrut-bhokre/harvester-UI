...
export const PRODUCT_NAME = 'zeus';
...
export const IP_POOL_HEADERS = [
  ...
  {
    name: 'subnet',
    labelKey: 'zeus.ipPool.subnet.label',
    value: 'subnetDisplay',
  },
  {
    name: 'availableIP',
    labelKey: 'zeus.ipPool.availableIP.label',
...
export function init($plugin, store) {
  ...
  if (isSingleVirtualCluster) {
    ...
    store.dispatch('setIsSingleProduct', {
      ...
      productNameKey: 'zeus.productLabel',
  ...
  basicType([HCI.HOST, HCI.BLOCK_DEVICE]);
  configureType(HCI.BLOCK_DEVICE, {
    location: {
      name: `${PRODUCT_NAME}-c-cluster-resource`,
      params: { resource: HCI.BLOCK_DEVICE }
    },
    resourceDetail: HCI.BLOCK_DEVICE,
    resourceEdit: HCI.BLOCK_DEVICE,
  });

  virtualType({
    ifHaveType: NODE,
    labelKey: 'zeus.host.label',
    group: 'Root',
    name: HCI.HOST,
    namespaced: true,
    weight: 399,
  ...
  virtualType({
    labelKey: 'zeus.virtualMachine.label',
    group: 'root',
    name: HCI.VM,
    namespaced: true,
    weight: 299,
  ...
  virtualType({ // needed to avoid 404 on refresh when combined with registerAddonSideNav()
    name: HCI.VMIMPORT,
    labelKey: 'zeus.addons.vmImport.labels.vmimport',
    group: 'vmimport',
    namespaced: true,
    route: {
      name: `${PRODUCT_NAME}-c-cluster-resource`,
  ...
  virtualType({ // needed to avoid 404 on refresh when combined with registerAddonSideNav()
    ...
    labelKey: 'zeus.addons.vmImport.labels.vmimportSourceVMWare',
    group: 'vmimport',
    namespaced: true,
    route: {
      name: `${PRODUCT_NAME}-c-cluster-resource`,
  ...
  virtualType({ // needed to avoid 404 on refresh when combined with registerAddonSideNav()
    ...
    labelKey: 'zeus.addons.vmImport.labels.vmimportSourceOpenStack',
    group: 'vmimport',
    namespaced: true,
    route: {
      name: `${PRODUCT_NAME}-c-cluster-resource`,
  ...
  virtualType({ // needed to avoid 404 on refresh when combined with registerAddonSideNav()
    ...
    labelKey: 'zeus.addons.vmImport.labels.vmimportSourceOVA',
    group: 'vmimport',
    namespaced: true,
    route: {
      name: `${PRODUCT_NAME}-c-cluster-resource`,
  ...
  virtualType({
    ifHave: IF_HAVE.MULTI_CLUSTER,
    labelKey: 'zeus.projectNamespace.label',
    group: 'root',
    namespaced: true,
  ...
  */
  ...
  /*
    ...
    virtualType({
      ...
      labelKey: 'zeus.monitoring.alertmanagerConfig.label',
    ...
    virtualType({
      labelKey: 'zeus.logging.clusterFlow.label',
    ...
    virtualType({
      labelKey: 'zeus.logging.clusterOutput.label',
    ...
    virtualType({
      labelKey: 'zeus.logging.flow.label',
      name: HCI.FLOW,
      namespaced: true,
      weight: 77,
      route: {
    ...
    virtualType({
      labelKey: 'zeus.logging.output.label',
      name: HCI.OUTPUT,
      namespaced: true,
      weight: 76,
      route: {
  ...
  */
  ...
  virtualType({
    labelKey: 'zeus.vmTemplate.label',
    group: 'root',
    name: TEMPLATE,
    namespaced: true,
    weight: 289,
  ...
  virtualType({
    labelKey: 'zeus.clusterNetwork.title',
  ...
  virtualType({
    labelKey: 'zeus.networkPolicy.label',
    name: NETWORK_POLICY,
    namespaced: true,
    weight: 186,
    route: {
  ...
  virtualType({
    labelKey: 'zeus.vmSnapshot.label',
  ...
  virtualType({
    labelKey: 'zeus.cloudTemplate.label',
  ...
  virtualType({
    labelKey: 'zeus.migconfiguration.label',
    group: 'advanced',
    weight: 12,
  ...
  virtualType({
    labelKey: 'zeus.loadBalancer.label',
    name: HCI.LB,
    namespaced: true,
    weight: 185,
    route: {
  ...
  headers(HCI.LB, [
    ...
    {
      name: 'workloadType',
      labelKey: 'zeus.loadBalancer.workloadType.label',
      value: 'workloadTypeDisplay',
    },
    {
      name: 'ipam',
      labelKey: 'zeus.loadBalancer.ipam.label',
      value: 'ipamDisplay',
    },
    AGE
  ]);
