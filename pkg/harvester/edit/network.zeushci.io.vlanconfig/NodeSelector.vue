...
export default {
  ...
  computed: {
    ...
    selectNodeOptions() {
      const out = [{
        label: this.t(`zeus.vlanConfig.scheduling.affinity.allNodes`),
        value: 'all'
      },
      {
        label: this.t(`zeus.vlanConfig.scheduling.affinity.specificNode`),
        value: 'nodeSelector'
      },
      {
        label: this.t(`zeus.vlanConfig.scheduling.affinity.schedulingRules`),
        value: 'custom'
      }];
