  ...
  <Card :show-highlight-border="false">
    ...
    <template #body>
      <LabeledSelect
        ...
        :label="t('zeus.harvesterVlanConfigMigrateDialog.targetClusterNetwork.label')"
        :placeholder="t('zeus.harvesterVlanConfigMigrateDialog.targetClusterNetwork.placeholder')"
