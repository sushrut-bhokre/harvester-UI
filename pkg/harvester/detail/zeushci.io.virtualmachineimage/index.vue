    ...
    >
      <div class="row">
        <div class="col span-12">
          <LabelValue
            v-if="isUpload"
            :name="t('zeus.image.fileName')"
            :value="imageName"
            class="mb-20"
          />
          <LabelValue
            v-else
            :name="t('zeus.image.url')"
            :value="url"
            class="mb-20"
          >
            <template #value>
      ...
      <div class="row">
        <div class="col span-12">
          <LabelValue
            :name="t('zeus.image.isEncryption')"
