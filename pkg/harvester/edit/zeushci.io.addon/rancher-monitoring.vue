...
<template>
  <Tabbed :side-tabs="true">
    ...
    <Tab
      ...
      name="prometheus"
      :label="t('zeus.setting.zeusMonitoring.section.prometheus')"
      :weight="-1"
    >
      <div class="row">
        <div class="col span-6">
          <LabeledInput
            ...
            :tooltip="t('zeus.setting.zeusMonitoring.tips.scrape')"
            :required="true"
            :mode="mode"
          />
        </div>
        <div class="col span-6">
          <LabeledInput
            ...
            :tooltip="t('zeus.setting.zeusMonitoring.tips.evaluation')"
            :required="true"
            :mode="mode"
          />
        </div>
      ...
      <div class="row mt-10">
        <div class="col span-6">
          <LabeledInput
            ...
            :tooltip="t('zeus.setting.zeusMonitoring.tips.retention')"
            :required="true"
            :mode="mode"
          />
        </div>
        <div class="col span-6">
          <LabeledInput
            ...
            :tooltip="t('zeus.setting.zeusMonitoring.tips.retentionSize')"
            :required="true"
            :mode="mode"
          />
        </div>
    ...
    <Tab
      v-if="value.spec.enabled"
      name="nodeExporter"
      :label="t('zeus.setting.zeusMonitoring.section.prometheusNodeExporter')"
      :weight="-2"
    >
      <div class="row mt-10">
        <div class="col span-6">
    ...
    <Tab
      ...
      name="grafana"
      :label="t('zeus.setting.zeusMonitoring.section.grafana')"
      :weight="-3"
    >
      <div class="row mt-10">
        <div class="col span-6">
