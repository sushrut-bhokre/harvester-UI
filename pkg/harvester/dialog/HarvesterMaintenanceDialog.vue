...
<template>
  <Card :show-highlight-border="false">
    <template #title>
      {{ t('zeus.host.enableMaintenance.title') }}
    </template>
    ...
    <template #body>
      <div>
        <Checkbox
          v-model:value="force"
          label-key="zeus.host.enableMaintenance.force"
      ...
      <Banner
        color="warning"
        :label="t('zeus.host.enableMaintenance.protip')"
      />
      ...
      <Banner
        ...
        class="mt-0"
        color="warning"
        :label-key="'zeus.host.enableMaintenance.shutDownVMs'"
      />
