...
<template>
  <div v-if="currentCluster">
    ...
    >
      <template #title>
        <t k="zeus.upgradePage.upgradeApp" />
      </template>
      ...
      <template #content>
        ...
        <div class="currentVersion mb-15">
          <span> <t k="zeus.upgradePage.currentVersion" /> </span>
        ...
        <div>
          <LabeledSelect
            ...
            class="mb-10"
            :label="t('zeus.upgradePage.versionLabel')"
          ...
          <div v-if="version">
            <p
              v-clean-html="t('zeus.upgradePage.releaseTip', {url: releaseLink}, true)"
              class="mb-10"
            ></p>
            ...
            <Checkbox
              ...
              class="check"
              type="checkbox"
              label-key="zeus.upgradePage.checkReady"
            />
          </div>
