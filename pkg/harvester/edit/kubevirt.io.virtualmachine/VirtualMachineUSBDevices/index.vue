  ...
  <div>
    <div class="row">
      <div class="col span-12">
        <Banner color="info">
          <t k="zeus.usb.howToUseDevice" />
        </Banner>
        <Banner
          v-if="selectedDevices.length > 0"
          color="info"
        >
          <t k="zeus.usb.deviceInTheSameHost" />
        </Banner>
      </div>
    </div>
    <template v-if="enabledDevices.length">
      ...
      <div
        ...
        class="text-error"
      >
        {{ t('zeus.usb.impossibleSelection') }}
      </div>
      <button
        type="button"
      ...
      >
        {{ showMatrix ? t('zeus.usb.hideCompatibility') : t('zeus.usb.showCompatibility') }}
      </button>
      <div
        v-if="showMatrix"
        class="row mt-20"
