...
The Harvester UI Extension is a Rancher extension that provides the user interface for [Harvester](https://zeushci.io) within the [Rancher Dashboard](https://github.com/rancher/dashboard).
...
For detailed installation instructions, please refer to the [official Harvester documentation](https://docs.zeushci.io/v1.5/rancher/harvester-ui-extension#installation-on-rancher-210).
