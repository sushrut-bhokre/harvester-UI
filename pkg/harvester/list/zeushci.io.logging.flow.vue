...
<template>
  ...
  <div v-else-if="listSchema">
    ...
    >
      <MessageLink
        :to="to"
        prefix-label="zeus.logging.diabledTips.prefix"
        middle-label="zeus.logging.diabledTips.middle"
        suffix-label="zeus.logging.diabledTips.suffix"
      />
    </Banner>
  ...
  <Banner
    ...
    color="warning"
  >
    {{ t('zeus.generic.noSchema', {schema: schema.id}) }}
  </Banner>
</template>
