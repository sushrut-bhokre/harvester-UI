...
<template>
  ...
  <div v-else>
    ...
    >
      <MessageLink
        :to="to"
        prefix-label="zeus.monitoring.alertmanagerConfig.diabledMonitoringTips.prefix"
        middle-label="zeus.monitoring.alertmanagerConfig.diabledMonitoringTips.middle"
        suffix-label="zeus.monitoring.alertmanagerConfig.diabledMonitoringTips.suffix"
      />
    </Banner>
    <Banner
    ...
    >
      <MessageLink
        :to="to"
        prefix-label="zeus.monitoring.alertmanagerConfig.diabledAlertingTips.prefix"
        middle-label="zeus.monitoring.alertmanagerConfig.diabledAlertingTips.middle"
        suffix-label="zeus.monitoring.alertmanagerConfig.diabledAlertingTips.suffix"
      />
    </Banner>
    <Banner color="info">
