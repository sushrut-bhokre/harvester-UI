    ...
    <div v-if="rows.length">
      ...
      >
        <span class="listener-name">
          <t k="zeus.loadBalancer.listeners.name.label" />
        </span>
        <span class="listener-protocol">
          <t k="zeus.loadBalancer.listeners.protocol.label" />
        </span>
        <span class="listener-port">
          <t k="zeus.loadBalancer.listeners.port.label" />
          <span class="text-error">
            *
          </span>
        </span>
        <span class="listener-backendPort">
          <t k="zeus.loadBalancer.listeners.backendPort.label" />
          <span class="text-error">
            *
          </span>
        </span>
      ...
      >
        ...
        <div class="target-port">
          ...
          <input
            ...
            min="1"
            max="65535"
            :placeholder="t('zeus.loadBalancer.listeners.backendPort.placeholder')"
            @input="queueUpdate"
          />
        </div>
        <div
