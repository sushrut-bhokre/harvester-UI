  ...
  methods: {
    willSave() {
      ...
      if (!this.valuesContentJson.hostname) {
        errors.push(this.t('validation.required', { key: this.t('zeus.addons.rancherVcluster.hostname') }, true));
      }

      if (!this.valuesContentJson.bootstrapPassword) {
        errors.push(this.t('validation.required', { key: this.t('zeus.addons.rancherVcluster.password') }, true));
      }
      ...
      <div class="row mb-20">
        <div class="col span-6">
          <LabeledInput
            ...
            label-key="zeus.addons.rancherVcluster.hostname"
            :required="true"
            :mode="mode"
        ...
        <div class="col span-6">
          <LabeledInput
            ...
            label-key="zeus.addons.rancherVcluster.rancherVersion"
            :required="true"
            :disabled="true"
          />
        </div>
      ...
      <div class="row mt-20">
        <div class="col span-6">
          <LabeledInput
            ...
            label-key="zeus.addons.rancherVcluster.password"
            :mode="mode"
            :required="true"
            type="password"
          />
