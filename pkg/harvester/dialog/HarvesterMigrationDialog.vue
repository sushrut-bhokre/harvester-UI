...
export default {
  ...
  computed: {
    ...
    cpuPinningAlertMessage() {
      return this.t('zeus.virtualMachine.cpuPinning.migrationMessage');
    },
  ...
  methods: {
    ...
    async apply(buttonDone) {
      ...
      if (!this.nodeName) {
        const name = this.$store.getters['i18n/t']('zeus.modal.migration.fields.nodeName.label');
  ...
  <Card :show-highlight-border="false">
    ...
    <template #body>
      ...
      <LabeledSelect
        ...
        :label="t('zeus.modal.migration.fields.nodeName.label')"
        :placeholder="t('zeus.modal.migration.fields.nodeName.placeholder')"
