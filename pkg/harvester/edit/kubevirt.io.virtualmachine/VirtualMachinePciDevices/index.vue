    ...
    >
      <div class="col span-12">
        <Banner color="warning">
          <p v-clean-html="t('zeus.pci.oldFormatDevices.help', {oldFormatDevicesHTML}, true)" />
        </Banner>
      </div>
    </div>
    <div v-else>
      <div class="row">
        <div class="col span-12">
          <Banner color="info">
            <t k="zeus.pci.howToUseDevice" />
          </Banner>
          <Banner
            v-if="selectedDevices.length > 0"
            color="info"
          >
            <t k="zeus.pci.deviceInTheSameHost" />
          </Banner>
        </div>
      </div>
      <template v-if="enabledDevices.length">
        ...
        <div
          ...
          class="text-error"
        >
          {{ t('zeus.pci.impossibleSelection') }}
        </div>
        <button
          type="button"
        ...
        >
          {{ showMatrix ? t('zeus.pci.hideCompatibility') : t('zeus.pci.showCompatibility') }}
        </button>
        <div
          v-if="showMatrix"
          class="row mt-20"
