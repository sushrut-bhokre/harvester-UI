      ...
      if (this.value.value) {
        try {
          ...
          this.mirrors.forEach((mirror) => {
            if (!mirror.key) {
              errors.push(this.t('validation.required', { key: this.t('zeus.setting.containerdRegistry.mirrors.registryName') }, true));
            }

            if (mirror.value.Endpoints.length === 0) {
              errors.push(this.t('validation.required', { key: this.t('zeus.setting.containerdRegistry.mirrors.endpoints') }, true));
            }
          });

          this.configs.forEach((config) => {
            if (!config.key) {
              errors.push(this.t('validation.required', { key: this.t('zeus.setting.containerdRegistry.configs.registryEDQNorIP') }, true));
            }
          });
        } catch (e) {
...
<template>
  <div>
    <h3>{{ t('zeus.setting.containerdRegistry.mirrors.mirrors') }}</h3>
    <div>
      <InfoBox
      ...
      >
        ...
        <div class="row mb-20">
          <div class="col span-12">
            <LabeledInput
              ...
              :mode="mode"
              required
              label-key="zeus.setting.containerdRegistry.mirrors.registryName"
        ...
        <div class="mb-20">
          <LabeledSelect
            ...
            :mode="mode"
            required
            label-key="zeus.setting.containerdRegistry.mirrors.endpoints"
            :multiple="true"
            :taggable="true"
            :searchable="true"
            :options="[]"
        ...
        <div class="row mb-20">
          <KeyValue
            ...
            :add-label="t('zeus.setting.containerdRegistry.mirrors.rewrite.addRewrite')"
            :mode="mode"
            :title="t('zeus.setting.containerdRegistry.mirrors.rewrite.rewrite')"
            :read-allowed="false"
    ...
    >
      {{ t('zeus.setting.containerdRegistry.mirrors.addMirror') }}
    </button>

    <hr class="divider mt-20 mb-20" />

    <h3>{{ t('zeus.setting.containerdRegistry.configs.configs') }}</h3>
    <div>
      <InfoBox
      ...
      >
          ...
          <div class="col span-12">
            <div class="col span-12">
              <LabeledInput
                ...
                :mode="mode"
                :placeholder="t('zeus.setting.containerdRegistry.configs.registryPlaceholder')"
                label-key="zeus.setting.containerdRegistry.configs.registryEDQNorIP"
                @update:value="update"
              />
            </div>
          </div>
        ...
        <div class="row mb-20">
          <div class="col span-6">
            <LabeledInput
              ...
              :mode="mode"
              label-key="zeus.setting.containerdRegistry.configs.username"
              @update:value="update"
            />
          </div>
          ...
          <div class="col span-6">
            <LabeledInput
              ...
              :mode="mode"
              label-key="zeus.setting.containerdRegistry.configs.password"
              @update:value="update"
            />
          </div>
        </div>
        ...
        <div class="row mb-20">
          <div class="col span-6">
            <LabeledInput
              ...
              type="multiline"
              :min-height="150"
              label-key="zeus.setting.containerdRegistry.configs.auth"
              @update:value="update"
            />
          </div>
          ...
          <div class="col span-6">
            <LabeledInput
              ...
              type="multiline"
              :min-height="150"
              label-key="zeus.setting.containerdRegistry.configs.identityToken"
              @update:value="update"
            />
          </div>
        </div>
        ...
        <div class="row">
          <LabeledSelect
            ...
            :mode="mode"
            label-key="zeus.setting.containerdRegistry.configs.insecureSkipVerify"
      ...
      <button
        ...
        @click="addConfig"
      >
        {{ t('zeus.setting.containerdRegistry.configs.addConfig') }}
      </button>
    </div>
  </div>
</template>
