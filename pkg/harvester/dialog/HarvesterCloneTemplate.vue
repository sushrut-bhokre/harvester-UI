        ...
        if (res._status === 200 || res._status === 204) {
          this.$store.dispatch(
            'growl/success',
            {
              ...
              message: this.t(
                'zeus.modal.createTemplate.message.success',
...
<template>
  <Card :show-highlight-border="false">
    <template #title>
      {{ t('zeus.modal.createTemplate.title') }}
    </template>
    ...
    <template #body>
      ...
      <LabeledInput
        ...
        class="mb-20"
        :label="t('zeus.modal.createTemplate.name')"
        required
      />

      <LabeledInput
        v-model:value="description"
        :label="t('zeus.modal.createTemplate.description')"
      />
      <Banner
