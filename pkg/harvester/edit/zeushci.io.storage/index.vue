...
import { DATA_ENGINE_V1, DATA_ENGINE_V2 } from '../../models/persistentvolumeclaim';
...
export default {
  ...
  data() {
    ...
    const volumeBindingModeOptions = [
      ...
      {
        label: this.t('zeus.storage.customize.volumeBindingMode.later'),
    ...
    provisioners() {
      ...
      csiDrivers.forEach(({ name }) => {
        ...
        case LONGHORN_DRIVER:
          out.push({
            label: `zeus.storage.storageClass.longhorn.${ DATA_ENGINE_V1 }.label`,
            value: `${ name }_${ DATA_ENGINE_V1 }`,
          });

          if (this.longhornSystemVersion === DATA_ENGINE_V2 || this.value.longhornVersion === DATA_ENGINE_V2) {
            out.push({
              label: `zeus.storage.storageClass.longhorn.${ DATA_ENGINE_V2 }.label`,
        ...
        case LVM_DRIVER:
          out.push({
            label: 'zeus.storage.storageClass.lvm.label',
            value: name,
          });
          break;
        }
  ...
  >
    ...
    <Tabbed :side-tabs="true">
      ...
      <Tab
        ...
        :label="t('zeus.storage.allowedTopologies.title')"
        :weight="-1"
        :tooltip="t('zeus.storage.allowedTopologies.tooltip')"
      >
        <ArrayList
      ...
      <Tab
        ...
        name="cdiSettings"
        :label="t('zeus.storage.cdiSettings.label')"
        :weight="-2"
      >
        <CDISettings
