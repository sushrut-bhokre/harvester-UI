...
export default {
  ...
  data() {
    return {
      options: {
        'footer.docs':   'https://docs.zeushci.io',
    ...
    <IndentedPanel>
      <div class="content mt-20">
        <div class="promo">
          ...
          >
            <h2>
              {{ t('zeus.modal.bundle.title') }}
            </h2>
            <div>
              <p class="pb-10">
                {{ t('zeus.modal.bundle.titleDescription') }}
              </p>
              <button
          ...
          >
            <h2>
              {{ t('zeus.support.kubeconfig.title') }}
            </h2>
            <div>
              <p class="pb-10">
                {{ t('zeus.support.kubeconfig.titleDescription') }}
              </p>
              <button
                class="btn role-secondary btn-sm"
                type="button"
            ...
            <div class="col span-6 box box-primary">
              <h2>
                <a
                  ...
                  target="_blank"
                  :href="rancherLink"
                >{{ t('zeus.support.internal.rancher.title') }} <i class="icon icon-external-link" /></a>
              </h2>
              <div>
                <p class="warning">
                  <t
                    k="zeus.support.internal.rancher.titleDescription"
                    :raw="true"
            ...
            <div class="col span-6 box box-primary">
              <h2>
                <a
                  ...
                  target="_blank"
                  :href="longhornLink"
                >{{ t('zeus.support.internal.longhorn.title') }} <i class="icon icon-external-link" /></a>
              </h2>
              <div>
                <p class="warning">
                  <t
                    k="zeus.support.internal.longhorn.titleDescription"
                    :raw="true"
                  />
                </p>
              </div>
        ...
        <div class="external">
          ...
          >{{ t('zeus.support.community.learnMore') }} <i class="icon icon-external-link" /></a>
          or
          <a
            href="https://www.suse.com/products/harvester/"
            target="_blank"
            rel="noopener noreferrer nofollow"
          >{{ t('zeus.support.community.pricing') }} <i class="icon icon-external-link" /></a>
        </div>
      </div>
    </IndentedPanel>
