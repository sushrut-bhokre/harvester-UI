    ...
    async saveDisk() {
      ...
      try {
        ...
        this.$store.dispatch('growl/success', {
          ...
          message: this.t('zeus.host.disk.notification.success', { name: this.value.metadata?.name || '' }),
        }, { root: true });
      } catch (err) {
    ...
    <div class="content">
      ...
      >
        <Tab
          name="basics"
          :weight="100"
          :label="t('zeus.host.tabs.basics')"
        >
          <LabeledInput
            v-model:value="customName"
            :label="t('zeus.host.detail.customName')"
            class="mb-20"
            :mode="mode"
          />
          ...
          <LabeledInput
            ...
            :label="t('zeus.host.detail.consoleUrl')"
            class="mb-20"
            :mode="mode"
          />
        </Tab>
        <Tab
          ...
          name="disk"
          :weight="80"
          :label="t('zeus.host.tabs.storage')"
        >
          <div
            v-if="longhornNode"
            class="row mb-20"
          >
            <div class="col span-12">
              <Tags
                ...
                :label="t('zeus.host.tags.label')"
                :add-label="t('zeus.host.tags.addLabel')"
                :mode="mode"
              />
            </div>
          </div>
          ...
          >
            ...
            <template #add>
              <ButtonDropdown
                v-if="!isView"
                :button-label="t('zeus.host.disk.add')"
        ...
        <Tab
          ...
          name="Hugepages"
          :weight="70"
          :label="t('zeus.host.tabs.hugepages')"
        >
          <HarvesterHugepages
            :node="value"
        ...
        <Tab
          ...
          name="Ksmtuned"
          :weight="70"
          :label="t('zeus.host.tabs.ksmtuned')"
        >
          <HarvesterKsmtuned
            :mode="mode"
            :node="value"
        ...
        >
          ...
          <div v-else-if="seederEnabled && !hasInventorySchema">
            <Banner
              color="info"
              :label="t('zeus.seeder.banner.noInventory')"
            />
          </div>
          <div v-else>
            <Banner
            ...
            >
              <MessageLink
                ...
                prefix-label="zeus.seeder.banner.enable.prefix"
                middle-label="zeus.seeder.banner.enable.middle"
                suffix-label="zeus.seeder.banner.enable.suffix"
              />
            </Banner>
            <Banner
              v-else
              color="warning"
              :label="t('zeus.seeder.banner.noAddon')"
            />
          </div>
        </Tab>
        <Tab
          name="labels"
          label-key="zeus.host.tabs.labels"
        >
          <KeyValue
            key="labels"
      ...
      <Banner
        ...
        color="warning"
        :label="t('zeus.host.disk.forceFormatted.toolTip')"
      />
    </div>
