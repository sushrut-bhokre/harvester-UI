...
export default {
  ...
  data() {
    ...
    const isHarvester = this.value?.type?.includes('zeushci');
  ...
  created() {
    ...
    if ( hasCustomComponent ) {
      ...
      // 'edit/zeushci.io.managedchart/rancher-monitoring.vue'
    ...
    clusterRegistrationUrlTip() {
      return new Promise((resolve) => {
        this.$store.dispatch('harvester/promptModal', {
          ...
          contentKey: 'zeus.setting.clusterRegistrationUrl.message'
        }, { root: true });
      });
    },
