    ...
    headers() {
      ...
      const cols = [
        ...
        },
        {
          name:        'vfAddresses',
          label:       'VF Addresses',
          labelKey:    'zeus.sriovgpu.vfAddresses',
        ...
        },
        {
          name:        'vGpuDevices',
          label:       'vGPU Devices',
          labelKey:    'zeus.sriovgpu.vGpuDevices',
...
<template>
  ...
  <div v-else-if="!hasSriovgpuAddon || !hasPCIAddon">
    ...
    >
      <MessageLink
        :to="toVGpuAddon"
        prefix-label="zeus.sriovgpu.goSetting.prefix"
        middle-label="zeus.sriovgpu.goSetting.middle"
        suffix-label="zeus.sriovgpu.goSetting.suffix"
      />
    </Banner>
    <Banner
      v-if="!hasPCIAddon"
