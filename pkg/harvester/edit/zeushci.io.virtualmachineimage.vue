...
<template>
  ...
  >
    ...
    >
      <Tab
        name="basic"
        :label="t('zeus.image.tabs.basics')"
        :weight="99"
      ...
      >
        <RadioGroup
          ...
          :labels="[
            ...
            t('zeus.image.sourceType.encrypt'),
            t('zeus.image.sourceType.decrypt'),
          ]"
          :mode="mode"
        />
        <div class="row mb-20 mt-20">
          <div class="col span-12">
            ...
            <LabeledInput
              ...
              :tooltip="t('zeus.image.urlTip', {}, true)"
            />
            ...
            <LabeledInput
              ...
              :mode="mode"
              :disabled="isEdit"
              label-key="zeus.image.checksum"
              :tooltip="t('zeus.image.checksumTip')"
            />
            ...
            <LabeledSelect
              ...
              :label="t('zeus.image.sourceImage')"
              :mode="mode"
              :disabled="isEdit"
              class="mb-20"
            />
