...
<template>
  <div>
    ...
    >
      ...
      <Tab
        name="networks"
        :label="t('zeus.virtualMachine.detail.tabs.networks')"
        class="bordered-table"
        :weight="5"
      >
        <Network
      ...
      <Tab
        name="keypairs"
        :label="t('zeus.virtualMachine.detail.tabs.keypairs')"
        class="bordered-table"
        :weight="4"
      >
      ...
      <Tab
        ...
        name="quotas"
        :label="t('zeus.tab.quotas')"
        :weight="3"
      >
        <LabelValue
          :name="t('zeus.snapshot.totalSnapshotSize')"
      ...
      <Tab
        v-if="showVmMetrics"
        name="vm-metrics"
        :label="t('zeus.virtualMachine.detail.tabs.metrics')"
        :weight="2.5"
      >
      ...
      <Tab
        name="cloudConfig"
        :label="t('zeus.virtualMachine.detail.tabs.cloudConfig')"
        class="bordered-table"
        :weight="2"
      >
        <CloudConfig
      ...
      <Tab
        name="event"
        :label="t('zeus.virtualMachine.detail.tabs.events')"
        :weight="1"
      >
        <Events
          :resource="vmi"
      ...
      <Tab
        name="migration"
        :label="t('zeus.virtualMachine.detail.tabs.migration')"
      >
        <Migration
          :value="value"
          :vmi-resource="vmi"
