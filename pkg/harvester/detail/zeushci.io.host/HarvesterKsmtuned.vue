...
import { ksmtunedMode, ksmtunedRunOption } from '../../edit/zeushci.io.host/HarvesterKsmtuned.vue';
...
export default {
  ...
  computed: {
    ...
    mergeNodesText() {
      return this.ksmtuned.spec?.mergeAcrossNodes ? this.t('zeus.host.ksmtuned.enable') : this.t('zeus.host.ksmtuned.disable');
    },
...
<template>
  <div>
    <template v-if="ksmtuned.status">
      <h2>
        {{ t('zeus.host.ksmtuned.configure') }}
      </h2>
      <div class="row mb-20">
        <div class="col span-4">
          <LabelValue
            :name="t('zeus.host.ksmtuned.run')"
            :value="runText"
          />
        </div>
      </div>
      ...
      >
        <div class="col span-4">
          <LabelValue
            :name="t('zeus.host.ksmtuned.thresCoef')"
            :value="thresCoef"
          />
        </div>
        <div class="col span-4">
        ...
        <div class="col span-4">
          <LabelValue
            :name="t('zeus.host.ksmtuned.enableMergeNodes')"
      ...
      <div v-if="showRunInformation">
        ...
        <h3>{{ t('zeus.host.ksmtuned.parameters.title') }}</h3>
        <div class="row mb-20">
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.parameters.boost')"
              :value="ksmtuned.spec.ksmtunedParameters.boost"
            />
          </div>
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.parameters.decay')"
          ...
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.parameters.sleepMsec')"
        ...
        <div class="row mb-20">
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.parameters.minPages')"
          ...
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.parameters.maxPages')"
      ...
      <div>
        ...
        <h3>
          <t
            k="zeus.host.ksmtuned.statistics.title"
            :raw="true"
          />
        </h3>
        <div class="row mb-20">
          <div class="col span-4">
            <LabelValue :name="t('zeus.host.ksmtuned.ksmStatus')">
              <template #value>
          ...
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.statistics.sharing')"
              :value="ksmtuned.status.sharing"
            />
          </div>
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.statistics.shared')"
        ...
        <div class="row mb-20">
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.statistics.unshared')"
          ...
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.statistics.volatile')"
          ...
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.statistics.fullScans')"
        ...
        <div class="row mb-20">
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.statistics.stableNodeDups')"
          ...
          <div class="col span-4">
            <LabelValue
              :name="t('zeus.host.ksmtuned.statistics.stableNodeChains')"
