...
import { DATA_ENGINE_V1 } from '../../../models/persistentvolumeclaim';
  ...
  <div>
    <div class="row">
      <div class="col span-6">
        <LabeledInput
          ...
          :label="t('zeus.storage.parameters.numberOfReplicas.label')"
          :required="true"
          :mode="mode"
          min="1"
          max="3"
      ...
      <div class="col span-6">
        <LabeledInput
          ...
          :label="t('zeus.storage.parameters.staleReplicaTimeout.label')"
          :required="true"
          :mode="mode"
          type="number"
        />
    ...
    <div class="row mt-10">
      <div class="col span-6">
        <LabeledSelect
          ...
          :label="t('zeus.storage.parameters.nodeSelector.label')"
          :options="nodeTags"
          :taggable="true"
          :multiple="true"
          :mode="mode"
        >
          <template #no-options="{ searching }">
            <span
              ...
              class="text-muted"
            >
              {{ t('zeus.storage.parameters.nodeSelector.no-options', null, true) }}
            </span>
          </template>
        </LabeledSelect>
      </div>
      <div class="col span-6">
        <LabeledSelect
          ...
          :label="t('zeus.storage.parameters.diskSelector.label')"
          :options="diskTags"
          :taggable="true"
          :multiple="true"
          :mode="mode"
        >
          <template #no-options="{ searching }">
            <span
              ...
              class="text-muted"
            >
              {{ t('zeus.storage.parameters.diskSelector.no-options', null, true) }}
            </span>
          </template>
        </LabeledSelect>
      </div>
    ...
    <div class="row mt-20">
      <RadioGroup
        ...
        :label="t('zeus.storage.parameters.migratable.label')"
        :mode="mode"
    ...
    <template v-if="value.volumeEncryptionFeatureEnabled">
      <div class="row mt-20">
        <RadioGroup
          ...
          :label="t('zeus.storage.volumeEncryption')"
          :mode="mode"
