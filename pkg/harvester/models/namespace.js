...
export default class HciNamespace extends namespace {
  get _availableActions() {
    ...
    const editQuotaAction = {
      action: 'editNSQuota',
      label: this.t('zeus.modal.quota.editQuota'),
  ...
  get nameDisplay() {
    ...
    if (name === 'cattle-local-user-passwords') {
      return 'zeus-local-user-passwords';
    }

    return super.nameDisplay.replace('harvester', 'zeus');
  }
}
