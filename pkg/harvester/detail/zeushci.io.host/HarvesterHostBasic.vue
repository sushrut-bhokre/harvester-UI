  ...
  computed: {
    ...
    nodeType() {
      if (this.value.isEtcd) {
        return this.t('zeus.host.detail.etcd');
      }

      if (this.value.isMaster) {
        return this.t('zeus.host.detail.management');
      }

      return this.t('zeus.host.detail.compute');
    },
    ...
    nodeRoleState() {
      if (!this.value.isEtcd) {
        ...
        if (promoteStatus === COMPLETE) {
          ...
          return this.t(`zeus.host.promote.${ isExistRoleStatus ? PROMOTE_SUCCEED : PROMOTE_RESTART }`);
        }
      }
...
<template>
  <div class="host-detail">
    <Banner
      ...
      color="error"
      label-key="zeus.host.detail.kvm.disableMessage"
    />
    <h3>{{ t('zeus.host.tabs.overview') }}</h3>
    <div class="row mb-20">
      <div class="col span-6">
        <LabelValue
          :name="t('zeus.host.detail.customName')"
          :value="customName"
        />
      </div>
      <div class="col span-6">
        <LabelValue
          :name="t('zeus.host.detail.hostIP')"
    ...
    <div class="row mb-20">
      <div class="col span-6">
        <LabelValue
          :name="t('zeus.host.detail.os')"
          :value="value.status.nodeInfo.osImage"
        />
      </div>
      <div class="col span-6">
        <div class="role">
          <LabelValue :name="t('zeus.host.detail.role')">
            <template #value>
              {{ nodeType }}
              <span
                v-if="nodeRoleState"
    ...
    <div class="row mb-20">
      <div class="col span-6">
        <LabelValue
          :name="t('zeus.host.detail.create')"
          :value="value.metadata.creationTimestamp"
        />
      </div>
      <div class="col span-6">
        <LabelValue
          :name="t('zeus.host.detail.update')"
    ...
    <div class="row mb-20">
      ...
      >
        <LabelValue
          :name="t('zeus.host.detail.cpuManager')"
          :value="cpuManagerStatus"
        />
      </div>
      <div class="col span-6">
        <LabelValue
          :name="t('zeus.host.detail.consoleUrl')"
    ...
    <div v-if="hasMetricNodeSchema">
      <hr class="divider" />
      <h3>{{ t('zeus.host.tabs.monitor') }}</h3>
      <div class="row mb-20">
        <div
          class="col"
          :class="{
        ...
        >
          <HarvesterStorageUsed
            :row="value"
            :resource-name="t('zeus.host.detail.storage')"
            :show-allocated="true"
          />
        </div>
      </div>
    ...
    <h3>{{ t('zeus.host.detail.more') }}</h3>
    <div class="row mb-20">
      <div class="col span-4">
        <LabelValue
          :name="t('zeus.host.detail.uuid')"
      ...
      <div class="col span-4">
        <LabelValue
          :name="t('zeus.host.detail.kernel')"
      ...
      <div class="col span-4">
        <LabelValue
          :name="t('zeus.host.detail.containerRuntime')"
    ...
    >
      ...
      >
        <LabelValue
          :name="t('zeus.host.detail.manufacturer')"
      ...
      >
        <LabelValue
          :name="t('zeus.host.detail.serialNumber')"
