        ...
        try {
          ...
          if (res._status === 200 || res._status === 204) {
            this.$store.dispatch('growl/success', {
              ...
              message: this.t('zeus.modal.hotplugVolume.success', { diskName: this.diskName, vm: this.actionResource.nameDisplay })
            }, { root: true });
...
<template>
  ...
  >
    <template #title>
      <h4
        v-clean-html="t('zeus.modal.hotplugVolume.title')"
