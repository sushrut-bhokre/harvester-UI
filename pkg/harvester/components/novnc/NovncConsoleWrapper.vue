...
<template>
  <div class="vm-console-wrapper">
    <div class="vm-console">
      <div class="combination-keys">
        ...
        >
          <button class="btn btn-sm bg-primary">
            {{ t("zeus.virtualMachine.detail.console.shortcutKeys") }}
          </button>
        ...
        >
          <button class="btn btn-sm bg-primary">
            {{ t("zeus.virtualMachine.detail.console.customShortcutKeys") }}
          </button>
          ...
          <template #popper>
            <div>
              <button
                ...
                @click="showKeysModal"
              >
                {{ t("zeus.virtualMachine.detail.console.management") }}
              </button>
            </div>
      ...
      />
      <p v-if="isDown">
        {{ t("zeus.virtualMachine.detail.console.down") }}
      </p>
    </div>
  </div>
</template>
