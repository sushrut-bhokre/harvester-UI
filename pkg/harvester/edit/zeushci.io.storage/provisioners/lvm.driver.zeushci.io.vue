  ...
  <div>
    <div class="row mt-10">
      <div class="col span-6">
        <LabeledSelect
          v-model:value="node"
          :label="t('zeus.storage.parameters.node.label')"
          :options="nodes"
          :mode="mode"
          :required="true"
        >
    ...
    <div class="row mt-10">
      <div class="col span-6">
        <LabeledSelect
          ...
          :label="t('zeus.storage.parameters.lvmVolumeGroup.label')"
        ...
        >
          <template #no-options="{ searching }">
            <span
              ...
              class="text-muted"
            >
              {{ t('zeus.storage.parameters.lvmVolumeGroup.no-options', null, true) }}
            </span>
          </template>
        </LabeledSelect>
      </div>
      <div class="col span-6">
        <LabeledSelect
          ...
          :label="t('zeus.storage.parameters.lvmVolumeGroupType.label')"
