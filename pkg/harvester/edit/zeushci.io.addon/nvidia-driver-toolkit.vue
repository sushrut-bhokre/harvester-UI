...
<template>
  <div>
    <Banner
      ...
      color="error"
      :label="t('zeus.addons.nvidiaDriverToolkit.parsingSpecError', null, { raw: true })"
    />
    <Tabbed
      v-else
      :side-tabs="true"
    >
      <Tab
        name="basic"
        :label="t('zeus.addons.nvidiaDriverToolkit.titles.basic')"
        :weight="1"
      >
        <RadioGroup
          ...
          >
            <div class="col span-6">
              <LabeledInput
                ...
                :mode="mode"
                :required="true"
                label-key="zeus.addons.nvidiaDriverToolkit.image.repository"
              />
            </div>
            <div class="col span-6">
              <LabeledInput
                ...
                :required="true"
                class="col span-6"
                label-key="zeus.addons.nvidiaDriverToolkit.image.tag"
              />
            </div>
          </div>
          <div class="row mb-15">
            <LabeledInput
              ...
              :mode="mode"
              :required="true"
              label-key="zeus.addons.nvidiaDriverToolkit.driver.location"
            />
          </div>
        </div>
      </Tab>
