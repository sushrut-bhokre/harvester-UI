  ...
  <div>
    <div class="row mb-20">
      <div class="col span-12">
        <div class="mb-10">
          {{ t('zeus.setting.sslCertificates.publicCertificate') }}
        </div>
        ...
        <div class="chooseFile">
          ...
          />
          <span :class="{ 'text-muted': !publicCertificateFileName }">{{ publicCertificateFileName ? publicCertificateFileName : t('zeus.generic.noFileChosen') }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="row mb-20">
      <div class="col span-12">
        <div class="mb-10">
          {{ t('zeus.setting.sslCertificates.privateKey') }}
        </div>
        ...
        <div class="chooseFile">
          ...
          />
          <span :class="{ 'text-muted': !privateKeyFileName }">{{ privateKeyFileName ? privateKeyFileName : t('zeus.generic.noFileChosen') }}</span>
        </div>
      </div>
    </div>
    ...
    <div class="row mb-20">
      <div class="col span-12">
        <div class="mb-10">
          {{ t('zeus.setting.sslCertificates.ca') }}
        </div>
        ...
        <div class="chooseFile">
          ...
          />
          <span :class="{ 'text-muted': !caFileName }">{{ caFileName ? caFileName : t('zeus.generic.noFileChosen') }}</span>
        </div>
      </div>
    </div>
  </div>
