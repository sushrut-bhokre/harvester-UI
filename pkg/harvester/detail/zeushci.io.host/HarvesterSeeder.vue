    ...
    <div v-if="enableInventory">
      <div class="row mb-20">
        <div class="col span-6">
          <LabelValue
            :name="t('zeus.seeder.inventory.host.label')"
            :value="value.spec.baseboardSpec.connection.host"
          />
        </div>
        <div class="col span-6">
          <LabelValue
            :name="t('zeus.seeder.inventory.port.label')"
      ...
      <div class="row">
        <div class="col span-6">
          <LabelValue
            :name="t('zeus.seeder.inventory.insecureTLS.label')"
            :value="value.spec.baseboardSpec.connection.insecureTLS ? t('generic.yes') : t('generic.no')"
          />
        </div>
        <div class="col span-6">
          <LabelValue
            :name="t('zeus.seeder.inventory.secret.label')"
      ...
      <div class="row mt-20">
        <div class="col span-6">
          <LabelValue
            :name="t('zeus.seeder.inventory.event.label')"
        ...
        >
          <LabelValue
            :name="t('zeus.seeder.inventory.pollingInterval.label')"
