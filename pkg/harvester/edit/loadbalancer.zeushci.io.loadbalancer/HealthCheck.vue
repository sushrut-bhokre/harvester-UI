      ...
      <div class="row mt-10">
        ...
        >
          <LabeledSelect
            ...
            :options="portOptions"
            required
            :label="t('zeus.service.healthCheckPort.label')"
            :disabled="disabled"
          />
        </div>
        <div class="col span-6">
          <LabeledInput
            ...
            :mode="mode"
            type="number"
            :label="t('zeus.service.healthCheckSuccessThreshold.label')"
            :tooltip="t('zeus.service.healthCheckSuccessThreshold.description')"
            :disabled="disabled"
          />
        </div>
      </div>
      <div class="row mt-10">
        <div class="col span-6">
          <LabeledInput
            ...
            :mode="mode"
            type="number"
            :label="t('zeus.service.healthCheckFailureThreshold.label')"
            :tooltip="t('zeus.service.healthCheckFailureThreshold.description')"
            :disabled="disabled"
          />
        </div>
        <div class="col span-6">
          <LabeledInput
            ...
            :mode="mode"
            type="number"
            :label="t('zeus.service.healthCheckPeriod.label')"
            :disabled="disabled"
          />
        </div>
      </div>
      <div class="row mt-10">
        <div class="col span-6">
          <LabeledInput
            ...
            :mode="mode"
            type="number"
            :label="t('zeus.service.healthCheckTimeout.label')"
            :disabled="disabled"
          />
        </div>
      </div>
