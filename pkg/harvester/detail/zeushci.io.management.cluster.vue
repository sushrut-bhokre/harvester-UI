...
<template>
  ...
  >
    ...
    >
      <h4
        v-clean-html="t('cluster.zeus.registration.step1', null, true)"
      />

      <h4
        v-clean-html="t('cluster.zeus.registration.step2', null, true)"
        class="mt-10"
      />

      <h4
        v-clean-html="t('cluster.zeus.registration.step3', null, true)"
        class="mt-10"
      />
