  ...
  methods: {
    ...
    willSave() {
      ...
      if (!this.parseDefaultValue.repository) {
        errors.push(this.t('validation.required', { key: this.t('zeus.setting.supportBundleImage.repo') }, true));
      }

      if (!this.parseDefaultValue.tag) {
        errors.push(this.t('validation.required', { key: this.t('zeus.setting.supportBundleImage.tag') }, true));
      }
  ...
  >
    <div class="col span-12">
      <LabeledInput
        ...
        :mode="mode"
        required
        label-key="zeus.setting.supportBundleImage.repo"
      />
      ...
      <LabeledInput
        ...
        :mode="mode"
        required
        label-key="zeus.setting.supportBundleImage.tag"
      />
      ...
      <LabeledSelect
        ...
        class="mb-20"
        required
        label-key="zeus.setting.supportBundleImage.imagePullPolicy"
