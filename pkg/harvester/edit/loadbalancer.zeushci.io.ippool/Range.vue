  ...
  <div>
      ...
      >
        ...
        >
          ...
          <span
            class="pool-gateway"
          >
            <t k="zeus.ipPool.gateway.label" />
          </span>
          <span
            v-if="row.type === 'range'"
            class="pool-startIP"
          >
            <t k="zeus.ipPool.startIP.label" />
          </span>
          <span
            v-if="row.type === 'range'"
            class="pool-endIP"
          >
            <t k="zeus.ipPool.endIP.label" />
          </span>
          <span
            v-if="showRemove"
            class="remove"
    ...
    >
      ...
      <button
        ...
        @click="addRange()"
      >
        <t k="zeus.ipPool.range.addLabel" />
      </button>
    </div>
  </div>
</template>
