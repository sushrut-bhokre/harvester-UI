    ...
    <div class="content">
      <div class="mb-20">
        <RadioGroup
          ...
          name="model"
          :options="[true,false]"
          :labels="[t('zeus.backup.restore.createNew'), t('zeus.backup.restore.replaceExisting')]"
      ...
      <div class="row">
        ...
        <div class="col span-6">
          <LabeledInput
            v-model:value="name"
            :disabled="!restoreNewVm"
            :label="t('zeus.backup.restore.virtualMachineName')"
      ...
      <LabeledSelect
        ...
        class="mb-20"
        :label="t('zeus.backup.restore.backup')"
      ...
      <Checkbox
        ...
        type="checkbox"
        :label="t('zeus.backup.restore.keepMacAddress')"
      />

      <LabeledSelect
        v-if="!restoreNewVm"
        v-model:value="deletionPolicy"
        :label="t('zeus.backup.restore.deletePreviousVolumes')"
